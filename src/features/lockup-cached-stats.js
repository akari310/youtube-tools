...
function injectShortsLockupCachedStats() {
  ...
  document.querySelectorAll('ytm-shorts-lockup-view-model').forEach(item => {
    ...
    const subhead = item.querySelector(
      '.ShortsLockupViewModelHostOutsideMetadataSubhead, .shortsLockupViewModelHostOutsideMetadataSubhead, .ShortsLockupViewModelHostMetadataSubhead, .shortsLockupViewModelHostMetadataSubhead'
    );
...
function hasUnprocessedLockups() {
  const normal =
    document.querySelectorAll('yt-lockup-view-model:not([data-yt-tools-lockup-stats])').length > 0;
  const shorts =
    document.querySelectorAll('ytm-shorts-lockup-view-model:not([data-yt-tools-shorts-stats])')
      .length > 0;
