      ...
      <div id="stats" class="tab-content">
        <div class="stats-container" role="group" aria-label="Watch statistics">
          ...
          <div class="panel-actions">
            <button id="exportStats" class="btn-mdcm btn-secondary" aria-label="Export statistics to clipboard">
              <i class="fas fa-copy"></i> Export
            </button>
            <button id="resetStats" class="btn-mdcm btn-secondary danger" aria-label="Reset all statistics">
