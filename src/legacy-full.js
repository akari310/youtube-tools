/* ============================================================
 * DEPRECATED — being phased out in favor of ES modules.
 * See src/features/ for modular replacements.
 * See src/settings/ for settings management.
 * See src/themes/ for theme engine.
...
if (video) {
  video.classList.add('yt-tools-audio-only-video');
  const player = video.closest('#movie_player') || video.closest('#player-container');
...
if (!bar) {
  ...
  bar.innerHTML = safeHTML(`<div class="like" aria-label="Likes"></div><div class="dislike" aria-label="Dislikes"></div>`);
  if (copyDesc) {
...
likeEl.style.flexBasis = `${likePct}%`;
dislikeEl.style.flexBasis = `${dislikePct}%`;
...
GM_addStyle(`
  ...
  :root {
    ...
    /* Refined menu options */
    .container-mdcm .options-mdcm {
    ...
    .container-mdcm .options-mdcm > label {
      display: block;
      min-width: 0;
    }

    .container-mdcm .toggle-row {
      min-height: 48px;
      display: flex;
      align-items: center;
      justify-content: space-between;
    ...
    .container-mdcm .toggle-row:hover {
      background: rgba(255, 255, 255, 0.085);
      border-color: rgba(255, 255, 255, 0.14);
      transform: translateY(-1px);
    }

    .container-mdcm .toggle-label-text {
      min-width: 0;
      color: var(--yt-enhance-menu-text, var(--text-custom));
      display: flex;
      align-items: center;
    ...
    .container-mdcm .toggle-label-text i {
      width: 16px;
      color: var(--yt-enhance-menu-accent, var(--primary-custom));
      text-align: center;
      font-size: 13px;
    }

    .container-mdcm .toggle-switch-mdcm {
      position: relative;
      display: inline-flex;
      flex: 0 0 auto;
      width: 38px;
    ...
    .container-mdcm .toggle-slider-mdcm {
      position: absolute;
      inset: 0;
      cursor: pointer;
    ...
    .container-mdcm .toggle-slider-mdcm::before {
      content: '';
      position: absolute;
      width: 16px;
      height: 16px;
    ...
    .container-mdcm .checkbox-mdcm:checked + .toggle-slider-mdcm {
      background: var(--yt-enhance-menu-accent, var(--primary-custom));
      border-color: var(--yt-enhance-menu-accent, var(--primary-custom));
    }

    .container-mdcm .checkbox-mdcm:checked + .toggle-slider-mdcm::before {
      transform: translateX(16px);
    }

    .container-mdcm .quality-selector-mdcm,
    .container-mdcm .slider-container-mdcm {
      background: rgba(255, 255, 255, 0.055);
      border: 1px solid rgba(255, 255, 255, 0.075);
      border-radius: 10px;
      padding: 11px;
    ...
    .container-mdcm .select-wrapper-mdcm,
    .container-mdcm .select-wrapper-mdcm label {
      display: flex;
      width: 100%;
      min-width: 0;
      flex-direction: column;
    ...
    .container-mdcm .quality-selector-mdcm select {
      width: 100%;
      min-height: 34px;
      padding: 7px 9px;
    ...
    .container-mdcm .quality-selector-mdcm select:focus,
    .container-mdcm .slider-mdcm:focus {
      outline: 2px solid color-mix(in srgb, var(--yt-enhance-menu-accent, var(--primary-custom)) 55%, transparent);
      outline-offset: 2px;
    }

    .container-mdcm .slider-container-mdcm label {
      display: flex;
      align-items: center;
      justify-content: space-between;
      gap: 8px;
    ...
    .video-info-grid-mdcm {
      display: grid;
      grid-template-columns: repeat(2, minmax(0, 1fr));
      gap: 8px;
    }

    .video-info-item-mdcm {
      min-width: 0;
      padding: 9px 10px;
...
.containerButtons > button:hover {
  ...
  /* Shorts action bar: keep icons/labels stable at browser zoom levels like 125%. */
  ytd-shorts reel-action-bar-view-model .yt-spec-button-shape-with-label,
  ytd-reel-video-renderer reel-action-bar-view-model .yt-spec-button-shape-with-label,
  reel-action-bar-view-model .yt-spec-button-shape-with-label {
  ...
  ytd-shorts reel-action-bar-view-model .yt-spec-button-shape-next--icon-button,
  ytd-reel-video-renderer reel-action-bar-view-model .yt-spec-button-shape-next--icon-button,
  reel-action-bar-view-model .yt-spec-button-shape-next--icon-button {
  ...
  ytd-shorts reel-action-bar-view-model .yt-spec-button-shape-next__icon,
  ytd-reel-video-renderer reel-action-bar-view-model .yt-spec-button-shape-next__icon,
  reel-action-bar-view-model .yt-spec-button-shape-next__icon,
  ytd-shorts reel-action-bar-view-model .yt-icon-shape,
  ytd-reel-video-renderer reel-action-bar-view-model .yt-icon-shape,
  reel-action-bar-view-model .yt-icon-shape {
  ...
  ytd-shorts reel-action-bar-view-model .yt-spec-button-shape-with-label__label,
  ytd-reel-video-renderer reel-action-bar-view-model .yt-spec-button-shape-with-label__label,
  reel-action-bar-view-model .yt-spec-button-shape-with-label__label {
    width: 58px !important;
    min-width: 58px !important;
    max-width: 58px !important;
    margin-top: 0 !important;
  ...
  ytd-shorts reel-action-bar-view-model .yt-spec-button-shape-with-label__label span,
  ytd-reel-video-renderer reel-action-bar-view-model .yt-spec-button-shape-with-label__label span,
  reel-action-bar-view-model .yt-spec-button-shape-with-label__label span,
  ytd-shorts reel-action-bar-view-model [role="text"],
  ytd-reel-video-renderer reel-action-bar-view-model [role="text"],
  reel-action-bar-view-model [role="text"] {
    display: block !important;
    max-width: 58px !important;
  ...
  ytd-shorts reel-action-bar-view-model [data-yt-tools-shorts-views] [role="text"],
  ytd-shorts reel-action-bar-view-model [data-yt-tools-shorts-rating] [role="text"],
  reel-action-bar-view-model [data-yt-tools-shorts-views] [role="text"],
  reel-action-bar-view-model [data-yt-tools-shorts-rating] [role="text"] {
  ...
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .ytSpecButtonShapeWithLabelHost {
  ...
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .ytSpecButtonShapeNextIconButton {
  ...
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .ytSpecButtonShapeNextIcon,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .ytIconWrapperHost,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .ytSpecIconShapeHost,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop yt-icon {
  ...
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .ytSpecButtonShapeWithLabelLabel,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .yt-spec-button-shape-with-label__label {
    width: 52px !important;
    min-width: 52px !important;
    max-width: 52px !important;
    margin-top: 0 !important;
  ...
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .ytAttributedStringHost,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop .yt-spec-button-shape-with-label__label span,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [role="text"] {
    display: block !important;
    max-width: 52px !important;
    white-space: nowrap !important;
    overflow: hidden !important;
  ...
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-classic] .yt-spec-button-shape-with-label__label,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-classic] .ytSpecButtonShapeWithLabelLabel {
    display: none !important;
  }

  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-classic] .ytSpecButtonShapeWithLabelHost,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-views] .ytSpecButtonShapeWithLabelHost,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-rating] .ytSpecButtonShapeWithLabelHost,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-classic] .yt-spec-button-shape-with-label,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-views] .yt-spec-button-shape-with-label,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-rating] .yt-spec-button-shape-with-label {
    width: 48px !important;
    min-width: 48px !important;
    max-width: 48px !important;
  }

  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-classic] .ytSpecButtonShapeNextIconButton,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-views] .ytSpecButtonShapeNextIconButton,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-rating] .ytSpecButtonShapeNextIconButton,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-classic] .yt-spec-button-shape-next--icon-button,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-views] .yt-spec-button-shape-next--icon-button,
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop [data-yt-tools-shorts-rating] .yt-spec-button-shape-next--icon-button {
  ...
  reel-action-bar-view-model.ytwReelActionBarViewModelHostDesktop pivot-button-view-model a {
    width: 44px !important;
    height: 44px !important;
    min-width: 44px !important;
    min-height: 44px !important;
  ...
  <div class="options-mdcm">
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="hide-comments-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-comment-slash"></i>Hide Comments</span>
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="autoplay-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-circle-pause"></i>Disable Autoplay</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="dislikes-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-thumbs-down"></i>Show Dislikes</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="like-dislike-bar-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-chart-simple"></i>Like vs Dislike bar</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="bookmarks-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-bookmark"></i>Bookmarks (timestamps)</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="continue-watching-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-forward"></i>Continue watching</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="shorts-channel-name-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-user"></i>Shorts: show channel name</span>
        <label class="toggle-switch-mdcm">
    ...
    <label>
      <div class="toggle-row" data-for="nonstop-playback-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-infinity"></i>Nonstop playback</span>
        <label class="toggle-switch-mdcm">
    ...
    <label>
      <div class="toggle-row" data-for="themes-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-palette"></i>Active Themes</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="translation-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-language"></i>Translate comments</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="avatars-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-image"></i>Download avatars</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="reverse-mode-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-arrow-right-arrow-left"></i>Reverse mode</span>
        <label class="toggle-switch-mdcm">
    ...
    <label>
      <div class="toggle-row" data-for="cinematic-lighting-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-gear"></i>${isYTMusic ? 'Ambient Mode' : 'Cinematic Mode'}</span>
        <label class="toggle-switch-mdcm">
    ...
    <label>
      <div class="toggle-row" data-for="wave-visualizer-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-wave-square"></i>Wave visualizer Beta</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${!isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="custom-timeline-color-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-clock"></i>Royal Purple Timeline</span>
        <label class="toggle-switch-mdcm">
    ...
    <label ${isYTMusic ? 'style="display:none"' : ''}>
      <div class="toggle-row" data-for="sync-cinematic-toggle">
        <span class="toggle-label-text"><i class="fa-solid fa-gear"></i>Sync Ambient Mode YT</span>
        <label class="toggle-switch-mdcm">
...
const url = videoId
  ? `${location.origin}/watch?v=${encodeURIComponent(videoId)}`
  : location.href;
...
function copyVideoInfoValue(type) {
...
window.__ytToolsVideoInfoIntervalId = setInterval(() => {
  if (!openMenu && !$id('headers')?.classList?.contains('active')) return;
...
button.addEventListener('click', () => {
  ...
  if (tabName === 'headers') updateVideoInfoPanel();
});
});
...
function applyYTMThemeVars(bgColor, textColor, secondaryText, menuBg, iconColor, raisedBg, progressColor, progressSecondary) {
  // When background image is active, keep backgrounds transparent
  const hasBgImage = !!localStorage.getItem('backgroundImage');
  const bgTransparent = hasBgImage ? 'transparent' : bgColor;
  const menuBgTransparent = hasBgImage ? 'transparent' : (menuBg || bgColor);
  const raisedTransparent = hasBgImage ? 'rgba(255,255,255,0.06)' : (raisedBg || bgColor);
  const navTransparent = hasBgImage ? 'rgba(0,0,0,0.4)' : bgColor;

  // YTM-specific variables
  $sp('--ytmusic-general-background', bgTransparent);
  $sp('--ytmusic-background', bgTransparent);
  ...
  $sp('--ytmusic-player-bar-background', raisedTransparent);
  $sp('--ytmusic-nav-bar-background', navTransparent);
  $sp('--ytmusic-search-background', menuBgTransparent);
  // Shared YT/YTM variables
  $sp('--yt-spec-general-background-a', bgTransparent);
  $sp('--yt-spec-general-background-b', bgTransparent);
  $sp('--yt-spec-general-background-c', bgTransparent);
...
function checkDarkMode() {
  ...
  if (settings.themes) {
    ...
    if (isDarkModeActive === 'dark' && !isThemeCustom) {
      ...
      html, body { 
        background-color: ${localStorage.getItem('backgroundImage') ? 'transparent' : '#0f0f0f'} !important;
      }
      `);
      ...
      if (isYTMusic) {
        addDynamicCss(`
          ...
          ytmusic-player-bar { background: rgba(0,0,0,0.35) !important; backdrop-filter: blur(16px) !important; -webkit-backdrop-filter: blur(16px) !important; }
          ytmusic-nav-bar { 
            background: transparent !important; 
          ...
          ytmusic-search-box #input-box { background: rgba(255,255,255,0.08) !important; backdrop-filter: blur(12px) !important; -webkit-backdrop-filter: blur(12px) !important; }
          #nav-bar-background, #nav-bar-divider { display: none !important; }
          ...
          #nav-bar-background, #nav-bar-divider, #mini-guide-background { display: none !important; }
...
if (url) {
  // Translucent theme tint over background image
  let overlayColor;
  if (themeColor && themeColor.includes('gradient')) {
    const colors = themeColor.match(/#[0-9a-fA-F]{3,8}/g);
    if (colors && colors.length > 0) {
      const c = colors[colors.length - 1];
      const r = parseInt(c.slice(1, 3), 16);
      const g = parseInt(c.slice(3, 5), 16);
      const b = parseInt(c.slice(5, 7), 16);
      overlayColor = `rgba(${r}, ${g}, ${b}, 0.35)`;
    } else {
      overlayColor = 'rgba(0,0,0,0.35)';
    }
  } else {
    overlayColor = themeColor || 'rgba(0,0,0,0.35)';
  }
  styleEl.textContent = `
  ${selector} {
  ...
  /* Keep engagement panels (Shorts comments, etc.) readable with solid background */
  ytd-engagement-panel-section-list-renderer,
  ytd-engagement-panel-section-list-renderer[target-id],
  ytd-engagement-panel-title-header-renderer,
  ytd-engagement-panel-title-header-renderer[shorts-panel],
  ytd-engagement-panel-title-header-renderer #header,
  ytd-engagement-panel-title-header-renderer[shorts-panel] #header,
  #content.ytd-engagement-panel-section-list-renderer,
  #header.ytd-engagement-panel-section-list-renderer,
...
// Run periodically during Shorts browsing
setInterval(() => {
if (window.location.pathname.startsWith('/shorts/')) {
  nukeShortsCinematic();
}
