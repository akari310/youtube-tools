...
def bump_version(type='auto'):
    ...
    meta_path = os.path.join(base_dir, 'src/00_meta.js')
    files_to_sync = [
        os.path.join(base_dir, 'src/17_const_ytmambientmode.js'),
        os.path.join(base_dir, 'src/15_function_parsecounttext_text.js')
    ]
