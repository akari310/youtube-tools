...
const dirs = ['src_clone/core', 'src_clone/utils', 'src_clone/ui', 'src_clone/features', 'src_clone/main'];
dirs.forEach(dir => {
...
console.log('Successfully cleaned and re-modularized the 9k line file!');
